...
return [
    ...
    |                   Supported Values: "Commands Group Name", "Shared Commands Name", "Full Path to Class".
    |                   Default: Registers Global Commands.
    |                   Example: (array) [
    |                       'admin', // Commands Group Name.
    |                       'status', // Shared Commands Name.
    ...
    */
    'bots'                         => [
        'vshtm_group_bot' => [
            'username'            => 'vshtm_group_bot',
            'token'               => env('TOKEN', 'YOUR-BOT-TOKEN'),
...
//            'tickets'
        ...
        */
        ...
        /* // Group Type: 2
           'subscription' => [
                'start', // Shared Commands Name.
                'stop', // Shared Commands Name.
           ],
        */
        ...
        /* // Group Type: 3
            ...
            'admin' => [
                'auth', // Commands Group Name.
                'stats' // Commands Group Name.
            ],
        */
        ...
        /* // Group Type: 4
           'myBot' => [
                'admin', // Commands Group Name.
                'subscription', // Commands Group Name.
                'status', // Shared Commands Name.
                'Acme\Project\Commands\BotCommand' // Full Path to Commands Class.
           ],
        */
    ],
